                        ...
                        <div class="card-body d-flex flex-column">
                          ...
                          <!-- Button Read/Listen -->
                            <div class="d-flex justify-content-between align-items-center" style="margin-bottom: 1rem;">
                                ...
                                <!-- Nút Đọc sách hoặc Nghe podcast -->
                                @if($product->type == 'ebook')
                                    <a href="{{ route('products.read', $product->id) }}" class="btn btn-primary">Đọc sách</a>
                                @elseif($product->type == 'podcast')
                                    <a href="{{ route('products.listen', $product->id) }}" class="btn btn-primary">Nghe podcast</a>
                                @endif
                            </div>
