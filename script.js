...
// Api setup
const API_KEY = "AIzaSyBIiy-mMOXYga-rPQfjeNb0WKDofLZ0lJE"; // LINK LẤY API KEY: https://aistudio.google.com/apikey
...
const chatHistory = [
    {
        role: "model",
        parts: [{ text: `Tôi là chat bot lấy dữ liệu từ trang web debook sẽ hỗ trợ bạn trả lời các câu hỏi về trang web. Bạn có câu hỏi gì không ?
            ` }],
    },
];
