...
Route::post('/blogs', [PostController::class, 'store'])->name('posts.store');
Route::post('/blogs/{id}/like', [PostController::class, 'like'])->name('posts.like');
Route::post('/blogs/{id}/comment', [PostController::class, 'addComment'])->name('posts.addComment');
